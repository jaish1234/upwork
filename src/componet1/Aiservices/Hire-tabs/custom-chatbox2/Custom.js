...
function Custom() {
    let hire = [
        ...
        {
          render2: <img src={a4} className="rounded-full r_b_img" alt="Not Found" />,
          man_name1: 'Slavik C.',
          dev_type: 'Chatbot Devloper',
          rate1: 'Top Rated Plus',
          dollar_rate1: '$50/hr',
          indian_r1: '5/5 (3 jobs)',
          button: 'Large Language Model',
          button1: 'Natural Network'
        },
        {
          render2: <img src={a5} className="rounded-full r_b_img" alt="Not Found" />,
          man_name1: 'Muhammed S.',
          dev_type: 'Chatbot Devloper',
          rate1: 'Top Rated',
          dollar_rate1: '$25/hr',
          indian_r1: '5/5',
          button: 'Natural Language Processing',
          button1: 'AI Chatbot'
        },
        {
            render2: <img src={a6} className="rounded-full r_b_img" alt="Not Found" />,
            man_name1: 'Manzoor A.',
            dev_type: 'Chatbot Devloper',
            rate1: 'Top Rated',
            dollar_rate1: '$15/hr',
